...
public class FullDataEntry extends Base_Class {
	...
	public void selectIndications() throws InterruptedException {
		...
		/*Iterator<String> itIndications = handles.iterator();
	    while (itIndications.hasNext()) {
	        System.out.println(itIndications.);
	        }
	    
	    driver = driver.switchTo().window(itIndications.next());// switch to new window
	...
	public void getAERNO() throws InterruptedException {
		...
		/*//driver.switchTo().defaultContent();
	    //driver.switchTo().frame("navig");
		String AerNumber=AerNo.getText();
		System.out.println("AER NO Is"+AerNumber);
		String AerNumber1=AerNo1.getText();
		System.out.println("AER NO Is"+AerNumber1);
		String AerNumber3=AerNo3.getText();
		System.out.println("AER NO Is"+AerNumber3);*/
